...
function About(){
    ...
    return(
        <div className="border overflow-y-scroll font-itim bg-background py-[31.5px] px-2 md:h-svh h-[85%] w-svw md:items-center flex md:flex-row md:flex-wrap flex-col 
