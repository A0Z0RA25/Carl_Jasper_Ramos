...
function Navbar() {
  ...
  return (
    <div className="md:mx-5 bg-banner md:h-full max-h-screen text-white overflow-y-scroll rounded border mb-5">
        <ul className='flex backdrop-blur-xl items-center h-14 z-50 md:relative fixed bottom-0 left-0 w-full justify-around mx-auto text-white md:rounded-bl-sm md:rounded-br-sm md:w-1/2'>
          {list.map((li) => (
