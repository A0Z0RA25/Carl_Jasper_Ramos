            ...
            <h1 className='text-center text-2xl font-semibold mt-2'>About Me</h1>
                ...
                <div className='grid md:grid-cols-4 gap-y-2 gap-x-1 mx-2 md:my-5'>
                    <div className='w-full flex flex-col justify-center text-center'>
                        <img alt="profile" className='md:w-[250px] w-[130px] h-[130px] md:h-[250px] md:rounded rounded-full mx-auto' src={myImg} />
                        <h3>You can call me CJ</h3>
                    </div>
                    <div className='text-center bg-white w-[80%] md:w-fit mx-auto text-black px-1 shadow-md rounded'>
                        ...
                        <motion.hr className='border border-black mx-auto' 
                                    ...
                                    transition={{duration: 2, animation: "easeInOut"}}
                                    viewport={{once: true}}/>
                        <p className='text-sm px-1 pb-5'>I've been studying programming (web development) 
                    ...
                    <div className='text-center bg-white w-[80%] md:w-fit  mx-auto text-black px-1 shadow-md rounded'>
                        ...
                        <motion.hr className='border border-black mx-auto' 
                                    ...
                                    transition={{duration: 2, animation: "easeInOut"}}
                                    viewport={{once: true}}/>
                        <p className='text-sm px-1 pb-5'>I'm currently a grade 12 STEM student and will graduate this 2025 , the 
                    ...
                    <div className='text-center bg-white w-[80%] md:w-fit  mx-auto text-black px-1 shadow-md rounded'>
                        ...
                        <motion.hr className='border border-black mx-auto' 
                                    ...
                                    transition={{duration: 2, animation: "easeInOut"}}
                                    viewport={{once: true}}/>
                        <p className='text-sm px-1 pb-5'>My goal is to finish college and to have a stable job, maybe a 
